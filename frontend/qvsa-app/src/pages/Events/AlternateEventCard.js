  ...
  return (
    <div className="flex flex-col md:flex-row-reverse border-t-2 border-white ml-2 md:ml-12 justify-center md:justify-end mb-6 w-auto">
      <div className="w-full md:w-8/12 p-4">
        <h1 className="font-Inter font-bold text-[#F2F2F2] text-4xl m-4 text-center md:text-left md:pr-3 md:break-words">
          <span className="text-[#FFB90B] md:hidden block">
            {" "}
            {month}, {year}{" "}
          </span>{" "}
          {title}
        </h1>
        <p className="font-Inter text-[#F2F2F2] text-lg text-center md:text-left m-4 pb-12 border-b-2 border-white md:pr-3 md:break-words">
          {description}
        </p>
      </div>
